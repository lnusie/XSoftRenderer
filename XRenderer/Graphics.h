...
{
public:
	static Matrix LookAtRH(Vec3f eye_pos, Vec3f target_pos, Vec3f up);
	...
	static void DrawTriangleOrthogonal(Vec4f *pts, IShader &shader, TGAImage &image, TGAImage & zbuffer);
};
